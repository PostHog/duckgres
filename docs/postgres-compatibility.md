...
| system.query_log | ✅ | `querylog_test.go` | DuckLake-backed durable per-org query history with `user_name`, timing, errors, trace IDs, `cpu_time_s`, `peak_buffer_memory_bytes`, and `postgres_scan_ms` |
