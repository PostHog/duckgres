...
| system.query_log | ❌ | — | Direct DuckLake writer removed; query rows are stored in native Postgres `querylog.query_log_entries`. SQL surface pending the Postgres-backed DuckLake view. |
