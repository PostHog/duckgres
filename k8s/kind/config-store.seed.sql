...
VALUES (
    ...
    -- adds the Iceberg REST catalog. Worker reaches Lakekeeper via the kind
    -- network alias; data S3 access reuses the ducklake_s3 MinIO secret.
    -- Connect with dbname=iceberg to use this catalog.
    true,
    'lakekeeper',
    'public',
    'us-east-1',
    'http://duckgres-lakekeeper:8181/catalog',
    'local',
    'ready',
    'kind local iceberg (lakekeeper) seeded',
    'duckgres',
