...
VALUES (
    ...
    'duckgres.yaml',
    'ready',
    'kind ci warehouse metadata',
    'ready',
    'kind ci warehouse db metadata seeded',
    'ready',
    'kind ci metadata store seeded',
    'ready',
    'kind ci object store metadata seeded',
    'ready',
    'kind ci worker identity metadata seeded',
    'ready',
    'kind ci secret refs seeded',
    NOW(),
    NULL,
    NOW(),
    NOW()
