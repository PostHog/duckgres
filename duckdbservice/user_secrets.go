...
//
// System-managed secrets (ducklake_s3, plus the reserved
// __default_*/duckgres_* prefixes) are preserved: activation re-creates them
// and dropping them would break the org's own catalog wiring.
