...
(
    ...
    'ready',
    'kind analytics warehouse db metadata seeded',
    'ready',
    'kind analytics metadata store seeded',
    'ready',
    'kind analytics object store metadata seeded',
    'ready',
    'kind analytics worker identity metadata seeded',
    'ready',
    'kind analytics secret refs seeded',
    NOW(),
    NULL,
    NOW(),
    NOW()
...
(
    ...
    'ready',
    'kind billing warehouse db metadata seeded',
    'ready',
    'kind billing metadata store seeded',
    'ready',
    'kind billing object store metadata seeded',
    'ready',
    'kind billing worker identity metadata seeded',
    'ready',
    'kind billing secret refs seeded',
    NOW(),
    NULL,
    NOW(),
    NOW()
