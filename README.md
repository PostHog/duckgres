...
together, then rerun the image builds. Both Dockerfiles verify the checksum and
test binary COPY with the bundled scanner. The nightly URLs can still change;
never remove checksum verification to work around a failure.
